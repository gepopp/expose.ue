        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('realestate.address.update', [$realEstate, $realEstateAddress]) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" maxlength="100" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') ?: $realEstateAddress->name }}" required autofocus>
                                        @if ($errors->has('name'))
                                            <span class="invalid-feedback" role="alert"><strong>{{ $errors->first('name') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="is_public" name="is_public" {{ $realEstateAddress->is_public ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="address_line_1" maxlength="100" type="text" class="form-control{{ $errors->has('address_line_1') ? ' is-invalid' : '' }}" name="address_line_1" value="{{ old('address_line_1') ?: $realEstateAddress->address_line_1 }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="address_line_2" maxlength="100" type="text" class="form-control{{ $errors->has('address_line_2') ? ' is-invalid' : '' }}" name="address_line_2" value="{{ old('address_line_2') ?: $realEstateAddress->address_line_2 }}">
                                ...
                                <div class="col-6">
                                    <label>Bild</label>
                                    <file-upload mfile="{{ json_encode([$realEstateAddress->image]) }}" maxfiles="1" folder="addressimages"></file-upload>
                                    ...
                                    <w-y-s-i-w-y-g name="description" content="{{ old('description') ?:  $realEstateAddress->description }}"></w-y-s-i-w-y-g>
